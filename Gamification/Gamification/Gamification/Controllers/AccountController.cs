...
namespace Gamification.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(IAccountManager accountManager, IAuthorizationService authorizationService, ApplicationDbContext db)
        {
        ...
        [AllowAnonymous]
        public IActionResult GetPoints(string userName)
        {
